...
export default function AnalyticsPage() {
  ...
  return (
    <div className='from-primary/10 to-secondary/10 min-h-screen bg-gradient-to-br px-2 py-8 md:px-8'>
      <div className='mx-auto max-w-7xl space-y-10'>
        <div className='mb-4 flex items-center justify-between'>
          <h1 className='text-primary text-4xl font-extrabold tracking-tight'>Platform Analytics</h1>
          <Button className='bg-red-600 text-white hover:bg-red-700' onClick={handleExportPDF}>
            Export to PDF
          </Button>
        </div>
        <div id='analytics-content'>
          ...
          <div className='grid gap-6 md:grid-cols-2 lg:grid-cols-4'>
            <Card className='bg-primary text-primary-foreground shadow-xl'>
              ...
              <CardContent>
                <div className='text-4xl font-extrabold'>
                  {loading ? <Loader2 className='animate-spin' /> : stats?.totalUsers}
                </div>
              </CardContent>
            </Card>
            <Card className='bg-secondary text-secondary-foreground shadow-xl'>
              ...
              <CardContent>
                <div className='text-4xl font-extrabold'>
                  {loading ? <Loader2 className='animate-spin' /> : stats?.totalFacilities}
                </div>
              </CardContent>
            </Card>
            <Card className='bg-primary text-primary-foreground shadow-xl'>
              ...
              <CardContent>
                <div className='text-4xl font-extrabold'>
                  {loading ? <Loader2 className='animate-spin' /> : stats?.totalBookings}
                </div>
              </CardContent>
            </Card>
            <Card className='bg-secondary text-secondary-foreground shadow-xl'>
              ...
              <CardContent>
                <div className='text-4xl font-extrabold'>
                  ₹{loading ? <Loader2 className='animate-spin' /> : stats?.totalRevenue.toLocaleString()}
                </div>
          ...
          <Card className='bg-primary/10 shadow-lg'>
            ...
            <CardContent className='h-80'>
              {monthlyBookings.length === 0 ? (
                <div className='text-muted-foreground flex h-full items-center justify-center'>No data</div>
              ) : (
