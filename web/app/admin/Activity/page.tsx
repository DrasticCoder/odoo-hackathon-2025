    ...
    const mock: Activity[] = [
      {
        ...
        description: 'SportZone Arena approved',
      ...
      },
      {
        ...
        description: 'john@example.com joined',
        user: { id: 'u2', name: 'John' },
    ...
    <div className='bg-primary/5 min-h-screen px-2 py-8 md:px-8'>
      <div className='mx-auto max-w-5xl space-y-8'>
        <div className='flex items-center justify-between'>
          <h1 className='text-primary text-3xl font-bold'>Activity Log</h1>
          <Button
            onClick={() => {
              setShowForm(true);
              setEditActivity(null);
                  ...
                  {activities.map((a) => (
                    <TableRow key={a.id}>
                      ...
                      <TableCell>
                        ...
                        <Button size='icon' variant='destructive' onClick={() => handleDelete(a.id)}>
