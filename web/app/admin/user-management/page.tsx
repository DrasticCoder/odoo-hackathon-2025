      ...
      <div className='mx-auto max-w-6xl space-y-8'>
        ...
        <div className='mb-4 flex gap-2'>
          ...
          <Select value={role} onValueChange={setRole}>
            <SelectTrigger className='w-36 max-w-xs'>
                ...
                <TableBody>
                  {users.map((u) => (
                    <TableRow key={u.id}>
                      ...
                      <TableCell>
                        <Button size='icon' variant='ghost' onClick={() => handleViewBookings(u)}>
                          <Eye className='h-4 w-4' />
                        </Button>
                        {u.isActive ? (
                          u.role === 'ADMIN' ? (
                            <Button size='icon' variant='destructive' disabled title='Cannot ban another admin'>
