...
export default function CourtForm({ initialData, facilities, onSubmit, isEdit = false }: CourtFormProps) {
  ...
  const initialOperatingHours = useMemo(() => {
  ...
  // Update operating hours when initial data changes
  useEffect(() => {
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          ...
          <div>
            ...
            {errors.sportType && <p className='text-destructive mt-1 text-sm'>{errors.sportType.message}</p>}
          </div>
          ...
          <div>
            ...
            <Input
              ...
              placeholder='0.00'
            />
            {errors.pricePerHour && <p className='text-destructive mt-1 text-sm'>{errors.pricePerHour.message}</p>}
          </div>
