...
export default function Settings() {
	...
	return (
		<div className="mx-auto w-full max-w-3xl p-4 sm:p-6 bg-background">
			<Card>
				<CardHeader>
					...
					{user?.role === 'OWNER' && (
						<>
							...
							<div className="space-y-3">
								...
								<p className="text-sm text-muted-foreground">Create or update your facilities from the owner dashboard.</p>
								<div className="flex flex-wrap gap-3">
									...
									<Button onClick={() => router.push('/owner/dashboard')} variant="outline">
										Go to Owner Dashboard
											...
											<div className="mt-4">
												{loadingFacilities ? (
													<div className="text-sm text-muted-foreground">Loading facilities...</div>
														...
														{myFacilities.map((fac) => (
															<li key={fac.id} className="flex items-center justify-between gap-3 p-3">
																<div>
																	...
																	<div className="text-xs text-muted-foreground">{fac.shortLocation || fac.address}</div>
																</div>
																<div className="flex items-center gap-2">
																	<Button size="sm" variant="outline" onClick={() => router.push(`/owner/facilities/${fac.id}`)}>
																		Edit
																	</Button>
						...
						<>
							...
							<div className="space-y-3">
								...
								<p className="text-sm text-muted-foreground">
									You can manage all users and facilities from the admin dashboard. To change your own credentials, use the fields above.
									For other users, go to User Management.
								</p>
								<div className="flex flex-wrap gap-3">
