...
export class FacilitiesController {
  ...
  create(@Body() createFacilityDto: CreateFacilityDto, @CurrentUser() currentUser: any) {
  ...
  findAll(@Query() query: FacilityQueryDto, @CurrentUser() currentUser?: any) {
  ...
  @ApiResponse({ status: 404, description: 'Facility not found' })
  update(@Param('id') id: string, @Body() updateFacilityDto: UpdateFacilityDto, @CurrentUser() currentUser: any) {
  ...
  approve(@Param('id') id: string, @Body() approveDto: ApproveFacilityDto, @CurrentUser() currentUser: any) {
  ...
  @ApiResponse({ status: 403, description: 'Forbidden - Admin role required' })
  @ApiResponse({ status: 400, description: 'Facility is not pending approval' })
  reject(@Param('id') id: string, @Body() rejectDto: ApproveFacilityDto, @CurrentUser() currentUser: any) {
